...
void test_kill() {
  ...
  14:	4b6080e7          	jalr	1206(ra) # 4c6 <fork>
        if(pid == 0)
  18:	c11d                	beqz	a0,3e <test_kill+0x3e>
    for (int i = 0; i < n_forks; i++) {
  1a:	2485                	addiw	s1,s1,1
  1c:	ff249ae3          	bne	s1,s2,10 <test_kill+0x10>
  ...
  26:	53c080e7          	jalr	1340(ra) # 55e <sleep>
        killsystem();
  2a:	00000097          	auipc	ra,0x0
  2e:	54c080e7          	jalr	1356(ra) # 576 <killsystem>
    }
}
  32:	60e2                	ld	ra,24(sp)
  34:	6442                	ld	s0,16(sp)
  ...
  42:	9ba90913          	addi	s2,s2,-1606 # 9f8 <malloc+0xe4>
  46:	85a6                	mv	a1,s1
  48:	854a                	mv	a0,s2
  4a:	00001097          	auipc	ra,0x1
  4e:	80c080e7          	jalr	-2036(ra) # 856 <printf>
            sleep(4);
  52:	4511                	li	a0,4
  54:	00000097          	auipc	ra,0x0
  58:	50a080e7          	jalr	1290(ra) # 55e <sleep>
        while(1){
  5c:	b7ed                	j	46 <test_kill+0x46>

000000000000005e <test_pause>:
...
void test_pause(int seconds) {
  ...
  76:	454080e7          	jalr	1108(ra) # 4c6 <fork>
        if(pid == 0)
  7a:	c50d                	beqz	a0,a4 <test_pause+0x46>
    for (int i = 0; i < n_forks; i++) {
  7c:	2485                	addiw	s1,s1,1
  7e:	ff349ae3          	bne	s1,s3,72 <test_pause+0x14>
            printf("this is process %d\n", k);
            sleep(4);
        }
    }
  ...
  88:	4da080e7          	jalr	1242(ra) # 55e <sleep>
        pausesystem(seconds);
  8c:	854a                	mv	a0,s2
  8e:	00000097          	auipc	ra,0x0
  92:	4e0080e7          	jalr	1248(ra) # 56e <pausesystem>
    }
}
  96:	70a2                	ld	ra,40(sp)
  98:	7402                	ld	s0,32(sp)
  ...
  a8:	95490913          	addi	s2,s2,-1708 # 9f8 <malloc+0xe4>
  ac:	85a6                	mv	a1,s1
  ae:	854a                	mv	a0,s2
  b0:	00000097          	auipc	ra,0x0
  b4:	7a6080e7          	jalr	1958(ra) # 856 <printf>
            sleep(4);
  b8:	4511                	li	a0,4
  ba:	00000097          	auipc	ra,0x0
  be:	4a4080e7          	jalr	1188(ra) # 55e <sleep>
        while(1){
  c2:	b7ed                	j	ac <test_pause+0x4e>

00000000000000c4 <pause_system_dem>:



void pause_system_dem(int interval, int pause_seconds, int loop_size) {
  c4:	715d                	addi	sp,sp,-80
  c6:	e486                	sd	ra,72(sp)
  c8:	e0a2                	sd	s0,64(sp)
  ca:	fc26                	sd	s1,56(sp)
  cc:	f84a                	sd	s2,48(sp)
  ...
  d4:	e85a                	sd	s6,16(sp)
  d6:	e45e                	sd	s7,8(sp)
  d8:	0880                	addi	s0,sp,80
  da:	8a2a                	mv	s4,a0
  dc:	8b2e                	mv	s6,a1
  de:	8932                	mv	s2,a2
    int pid = getpid();
  e0:	00000097          	auipc	ra,0x0
  e4:	46e080e7          	jalr	1134(ra) # 54e <getpid>
    for (int i = 0; i < loop_size; i++) {
  e8:	05205b63          	blez	s2,13e <pause_system_dem+0x7a>
  ec:	8aaa                	mv	s5,a0
        if (i % interval == 0 && pid == getpid()) {
            printf("pause system %d/%d completed.\n", i, loop_size);
        }
        if (i == loop_size / 2) {
  ee:	01f9599b          	srliw	s3,s2,0x1f
  f2:	012989bb          	addw	s3,s3,s2
  f6:	4019d99b          	sraiw	s3,s3,0x1
    for (int i = 0; i < loop_size; i++) {
  fa:	4481                	li	s1,0
            printf("pause system %d/%d completed.\n", i, loop_size);
  fc:	00001b97          	auipc	s7,0x1
 100:	914b8b93          	addi	s7,s7,-1772 # a10 <malloc+0xfc>
 104:	a031                	j	110 <pause_system_dem+0x4c>
        if (i == loop_size / 2) {
 106:	02998663          	beq	s3,s1,132 <pause_system_dem+0x6e>
    for (int i = 0; i < loop_size; i++) {
 10a:	2485                	addiw	s1,s1,1
 10c:	02990963          	beq	s2,s1,13e <pause_system_dem+0x7a>
        if (i % interval == 0 && pid == getpid()) {
 110:	0344e7bb          	remw	a5,s1,s4
 114:	fbed                	bnez	a5,106 <pause_system_dem+0x42>
 116:	00000097          	auipc	ra,0x0
 11a:	438080e7          	jalr	1080(ra) # 54e <getpid>
 11e:	ff5514e3          	bne	a0,s5,106 <pause_system_dem+0x42>
            printf("pause system %d/%d completed.\n", i, loop_size);
 122:	864a                	mv	a2,s2
 124:	85a6                	mv	a1,s1
 126:	855e                	mv	a0,s7
 128:	00000097          	auipc	ra,0x0
 12c:	72e080e7          	jalr	1838(ra) # 856 <printf>
 130:	bfd9                	j	106 <pause_system_dem+0x42>
            pausesystem(pause_seconds);
 132:	855a                	mv	a0,s6
 134:	00000097          	auipc	ra,0x0
 138:	43a080e7          	jalr	1082(ra) # 56e <pausesystem>
 13c:	b7f9                	j	10a <pause_system_dem+0x46>
        }
    }
    printf("\n");
 13e:	00001517          	auipc	a0,0x1
 142:	8f250513          	addi	a0,a0,-1806 # a30 <malloc+0x11c>
 146:	00000097          	auipc	ra,0x0
 14a:	710080e7          	jalr	1808(ra) # 856 <printf>
}
 14e:	60a6                	ld	ra,72(sp)
 150:	6406                	ld	s0,64(sp)
 152:	74e2                	ld	s1,56(sp)
 154:	7942                	ld	s2,48(sp)
 156:	79a2                	ld	s3,40(sp)
 158:	7a02                	ld	s4,32(sp)
 15a:	6ae2                	ld	s5,24(sp)
 15c:	6b42                	ld	s6,16(sp)
 15e:	6ba2                	ld	s7,8(sp)
 160:	6161                	addi	sp,sp,80
 162:	8082                	ret

0000000000000164 <kill_system_dem>:
...
void kill_system_dem(int interval, int loop_size) {
 ...
 180:	3d2080e7          	jalr	978(ra) # 54e <getpid>
    for (int i = 0; i < loop_size; i++) {
 184:	05205a63          	blez	s2,1d8 <kill_system_dem+0x74>
 188:	8aaa                	mv	s5,a0
        if (i % interval == 0 && pid == getpid()) {
            printf("kill system %d/%d completed.\n", i, loop_size);
        }
        if (i == loop_size / 2) {
 18a:	01f9599b          	srliw	s3,s2,0x1f
 18e:	012989bb          	addw	s3,s3,s2
 192:	4019d99b          	sraiw	s3,s3,0x1
    for (int i = 0; i < loop_size; i++) {
 196:	4481                	li	s1,0
            printf("kill system %d/%d completed.\n", i, loop_size);
 198:	00001b17          	auipc	s6,0x1
 19c:	8a0b0b13          	addi	s6,s6,-1888 # a38 <malloc+0x124>
 1a0:	a031                	j	1ac <kill_system_dem+0x48>
        if (i == loop_size / 2) {
 1a2:	02998663          	beq	s3,s1,1ce <kill_system_dem+0x6a>
    for (int i = 0; i < loop_size; i++) {
 1a6:	2485                	addiw	s1,s1,1
 1a8:	02990863          	beq	s2,s1,1d8 <kill_system_dem+0x74>
        if (i % interval == 0 && pid == getpid()) {
 1ac:	0344e7bb          	remw	a5,s1,s4
 1b0:	fbed                	bnez	a5,1a2 <kill_system_dem+0x3e>
 1b2:	00000097          	auipc	ra,0x0
 1b6:	39c080e7          	jalr	924(ra) # 54e <getpid>
 1ba:	ff5514e3          	bne	a0,s5,1a2 <kill_system_dem+0x3e>
            printf("kill system %d/%d completed.\n", i, loop_size);
 1be:	864a                	mv	a2,s2
 1c0:	85a6                	mv	a1,s1
 1c2:	855a                	mv	a0,s6
 1c4:	00000097          	auipc	ra,0x0
 1c8:	692080e7          	jalr	1682(ra) # 856 <printf>
 1cc:	bfd9                	j	1a2 <kill_system_dem+0x3e>
            killsystem();
 1ce:	00000097          	auipc	ra,0x0
 1d2:	3a8080e7          	jalr	936(ra) # 576 <killsystem>
 1d6:	bfc1                	j	1a6 <kill_system_dem+0x42>
        }
    }
    printf("\n");
 1d8:	00001517          	auipc	a0,0x1
 1dc:	85850513          	addi	a0,a0,-1960 # a30 <malloc+0x11c>
 1e0:	00000097          	auipc	ra,0x0
 1e4:	676080e7          	jalr	1654(ra) # 856 <printf>
}
 1e8:	70e2                	ld	ra,56(sp)
 1ea:	7442                	ld	s0,48(sp)
...
void check(){
 ...
 210:	2ba080e7          	jalr	698(ra) # 4c6 <fork>
        if(pid == 0)
 214:	c911                	beqz	a0,228 <check+0x2c>
    for (int i = 0; i < n_forks; i++) {
 216:	2485                	addiw	s1,s1,1
 218:	ff249ae3          	bne	s1,s2,20c <check+0x10>
    if(pid==0){
        while(1){
            printf("this is process %d\n", k);
        }
 ...
 226:	8082                	ret
            printf("this is process %d\n", k);
 228:	00000917          	auipc	s2,0x0
 22c:	7d090913          	addi	s2,s2,2000 # 9f8 <malloc+0xe4>
 230:	85a6                	mv	a1,s1
 232:	854a                	mv	a0,s2
 234:	00000097          	auipc	ra,0x0
 238:	622080e7          	jalr	1570(ra) # 856 <printf>
        while(1){
 23c:	bfd5                	j	230 <check+0x34>
...
main(int argc, char *argv[])
{
 ...
 24a:	fb6080e7          	jalr	-74(ra) # 1fc <check>
    exit(0);
 24e:	4501                	li	a0,0
...
000000000000056e <pausesystem>:
.global pausesystem
pausesystem:
 li a7, SYS_pausesystem
 56e:	48d9                	li	a7,22
 ecall
 570:	00000073          	ecall
 ret
...
0000000000000576 <killsystem>:
.global killsystem
killsystem:
 li a7, SYS_killsystem
 576:	48dd                	li	a7,23
 ecall
 578:	00000073          	ecall
 ret
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 5c6:	49e50513          	addi	a0,a0,1182 # a60 <digits>
 5ca:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 7d2:	28a90913          	addi	s2,s2,650 # a58 <malloc+0x144>
        while(*s != 0){
...
free(void *ap)
{
 ...
 89a:	1e27b783          	ld	a5,482(a5) # a78 <freep>
 ...
 8c8:	00e6ea63          	bltu	a3,a4,8dc <free+0x50>
{
 ...
 90a:	16f73923          	sd	a5,370(a4) # a78 <freep>
}
 90e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 93c:	14053503          	ld	a0,320(a0) # a78 <freep>
 ...
 964:	11890913          	addi	s2,s2,280 # a78 <freep>
  if(p == (char*)-1)
 968:	5afd                	li	s5,-1
 96a:	a88d                	j	9dc <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 96c:	00000797          	auipc	a5,0x0
 970:	11478793          	addi	a5,a5,276 # a80 <base>
 974:	00000717          	auipc	a4,0x0
 978:	10f73223          	sd	a5,260(a4) # a78 <freep>
 97c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 99e:	0ca73f23          	sd	a0,222(a4) # a78 <freep>
      return (void*)(p + 1);
